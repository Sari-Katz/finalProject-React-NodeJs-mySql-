...
router.delete('/:id',authenticateToken, requireRole('admin'), challengeController.deleteChallenge);//לא בשימוש כרגע
router.get('/:challengeId/completions',authenticateToken, requireRole('admin'), challengeController.getChallengeCompletions); // כל מי שהשלים את האתגר
